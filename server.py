    ...
    def handle_request(self):
        try:
            ...
            if path == '/api/auth/password' and method == 'POST' and auth:
                ...
                return self.send({'ok': True}, cookie=self.session_cookie())
            if method == 'GET':
                static = {'/vendor/rich-editor.js': 'vendor/rich-editor.js', '/vendor/mermaid-runtime.js': 'vendor/mermaid-runtime.js', '/mermaid-renderer.js': 'mermaid-renderer.js', '/accounts-ui.js': 'accounts-ui.js', '/auth-ui.js': 'auth-ui.js', '/login.css': 'login.css', '/cell-export.html': 'cell-export.html', '/cell-export.js': 'cell-export.js', '/cell-export.css': 'cell-export.css', '/vendor/html-to-image.js': 'vendor/html-to-image.js', '/': 'index.html', '/app.js': 'app.js', '/style.css': 'style.css', '/notebook.js': 'notebook.js', '/notebook-core.mjs': 'notebook-core.mjs', '/vendor/katex.mjs': 'vendor/katex.mjs', '/brand/process-log-logo.png': 'brand/process-log-logo.png'}
                if path in static:
